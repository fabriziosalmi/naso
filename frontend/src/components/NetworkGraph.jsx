  ...
  return (
    <div className="w-full h-full bg-black/20 rounded-2xl overflow-hidden border border-white/5 relative">
      <div className="absolute top-4 left-6 z-10 space-y-1 pointer-events-none">
        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-naso-accent">Intelligence Topology</p>
        <p className="text-[9px] text-zinc-500 font-bold uppercase">Interactive Force-Directed Graph (DD)</p>
      </div>
      ...
      <ForceGraph2D
        ...
        nodeCanvasObject={(node, ctx, globalScale) => {
          ...
          // Glow effect
          if (node.risk >= 80 || node.isProtected) {
              ctx.shadowBlur = 15;
