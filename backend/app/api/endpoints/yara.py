...
from ...schemas import YaraRule as YaraRuleSchema, YaraRuleCreate
...
async def create_yara_rule(
    ...
    await AuditLogger.log(
        ...
        action="CREATE_YARA_RULE", resource_type="yara_rule", resource_id=db_rule.id,
...
async def delete_yara_rule(
    ...
    await AuditLogger.log(
        db, user_id=current_user.id, tenant_id=current_user.tenant_id,
        action="DELETE_YARA_RULE", resource_type="yara_rule", resource_id=rule_id,
